...
script.on_init(
	function()
		...
		vehicle_armor_transformers = { }
		vehicle_armor_transformers.trans = { }
		vehicle_armor_transformers.trans2 = { }
		vehicle_armor_transformers.trans3 = { }
		global.vehicle_armor_transformers = vehicle_armor_transformers
...
script.on_load(
	function()
		...
		vehicle_armor_transformers = global.vehicle_armor_transformers
		if vehicle_armor_transformers.trans == nil then
			vehicle_armor_transformers.trans = { }
			vehicle_armor_transformers.trans2 = { }
			vehicle_armor_transformers.trans3 = { }
		end
...
script.on_event(defines.events.on_tick,
	function(event)
		...
		update_vehicle_transformer(tickdelay, vehicle_armor_transformers.trans, 'personal-transformer-equipment', 'personal-transformer-input-entity', 'personal-transformer-output-entity', 200000)
		update_vehicle_transformer(tickdelay, vehicle_armor_transformers.trans2, 'personal-transformer-mk2-equipment', 'personal-transformer-mk2-input-entity', 'personal-transformer-mk2-output-entity', 1000000)
		update_vehicle_transformer(tickdelay, vehicle_armor_transformers.trans3, 'personal-transformer-mk3-equipment', 'personal-transformer-mk3-input-entity', 'personal-transformer-mk3-output-entity', 4000000)
...
function update_vehicle_transformer(tickdelay, char_table, equip_name, input_name, output_name, max_draw)
	local dt = tickdelay / 60
	local buffer = max_draw / 10
	local _, p, t, v, grid = nil
	for _, p in pairs(game.players) do
